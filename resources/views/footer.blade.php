		...
		<div class="row text-center text-md-left">
          ...
          ital consectetur lorem ipsum dolor sit amet adipisicing elit.</p>
			...
			<div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
				...
				<p>
					<i class="fas fa-home mr-3"></i>Karachi, Sindh
				</p>
				<p>
					<i class="fas fa-envelope mr-3"></i>aliakbarlundbaloch@gmail.com
				</p>
				<p>
					<i class="fas fa-phone mr-3"></i>+92 3103726561
				</p>
				<p>
			...
			<div class="col-md-7 col-lg-8">
				<p>	Copyright ©2020 All rights reserved by:
					<a href="#" style="text-decoration: none;">
						<strong class="text-warning">Ali Akbar Baloch</strong>
					</a></p>
